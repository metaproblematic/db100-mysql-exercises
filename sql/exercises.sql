...
SELECT payment_id, amount, payment_date FROM payments WHERE payment_date >= '2005-05-27';
...
SELECT payment_id, amount, payment_date FROM payment WHERE DATE(payment_date) IN (DATE('2005-25-05'), DATE('2005-27-05'), DATE('2005-29-05'));
...
SELECT * FROM payment WHERE payment_date BETWEEN '2005-05-25' AND '2005-05-26 23:59:59';
...
SELECT DISTINCT rating FROM film ORDER BY DESC; 
